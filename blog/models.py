...
class Post(models.Model):
    ...
    # We have imported the User model from the django.contrib.auth.models module and we have added an author field to
    # the Post model. This field defines a many-to-one relationship, meaning that each post is written by a user,
    ...
    def __str__(self):
        # default Python method to return a string with the human-readable representation of the object. Django will
        # use this method to display the name of the object in many places, such as the Django administration site.
        return self.title
